...
<template>
  <div class="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8">
      ...
      <!-- Password Reset Form -->
      <div v-if="showPasswordReset" class="bg-gray-50 rounded-lg p-4">
        ...
        <form @submit.prevent="handlePasswordReset">
          ...
          <button
            type="submit"
            class="w-full py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-gray-600 hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
          >
            Send Reset Email
          </button>
        </form>
